  ...
  return (
    ...
    >
      ...
      <p className="max-w-lg text-sm text-neutral-600 text-center mx-auto mt-4 dark:text-neutral-400">
        Featuring 300+ available LLMs for your agents. Select from a range of models with ease, leave complexities to us.
      </p>
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            ...
            <CardDescription>
              Deploy your AI in seconds, with our one click deploy feature.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Intuitive architecture</CardTitle>
            <CardDescription>
              With our intuitive backend, we allow you to  easily build custom tools and actions.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Access over the edge</CardTitle>
            <CardDescription>
              With our ai platform, we host your agent by going into each
              city by ourselves.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>Personalize your agent</CardTitle>
            <CardDescription>
              Personalize your agent to your needs, with our avilable ai plugins. 
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
  ...
  return (
    <div className="relative flex items-center justify-center  w-full h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-lg mx-auto w-full relative z-30 [perspective:1000px] [transform-style:preserve-3d] p-8 sm:p-0">
        ...
        >
          <AWSLogo />
          <p className="text-[8px] bg-transparent ">your ai agent is live ✨</p>
        </Container>
      </div>
    </div>
  );
