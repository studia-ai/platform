...
import { Doc, Id } from "@/app/(platform)/convex/_generated/dataModel";
...
import WelcomeMessage from "@/app/(platform)/components/WelcomeMessage";
import { createSSEParser } from "@/lib/SSEParser";
import { MessageBubble } from "@/app/(platform)/components/MessageBubble";
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@/app/(platform)/components/ui/select";
